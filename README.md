...
The API _roughly_ follows high-level functions from [PyCuda](https://homepages.math.uic.edu/~jan/mcs572f16/mcs572notes/lec29.html#pycuda). See the [Usage](#usage) section below for examples on how to use the API.
